...
import { fetchUserProfileSignatures, isSignatureValid, getSignatureDisplayName } from './signatureUtils';
...
// Define styles for the PDF - matching the old design exactly
...
export async function generateEnhancedProposalPDF(proposal: ProposalWithJoins) {
  try {
